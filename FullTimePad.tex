...
\\
the word \textbf{decrypts} and $\textbf{A}_i$ is arbitrary. This is an initial array. In the confusion algorithm, every $\textbf{A}_i$ is modified twice. This makes the algorithm harder to reverse.
