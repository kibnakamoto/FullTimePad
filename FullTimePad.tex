...
& \quad \log_bb! \approx \frac{b\log b - b + \frac{\log\biggl[ b(1+4b(1+2b)) \biggr]}{6} + \frac{log\pi}{2}}{\log b} \\
& \texttt{And} \\
& \\
& \log_b(b-k)! \approx \frac{(b-k)\log(b-k) - (b-k) + \frac{\log \biggl[ (b-k)(1+4(b-k)(1+2(b-k)))\biggr]}{6} + \frac{\log\pi}{2}}{\log b} \\
& \\
& \texttt{Recall: } \\
...
& \log_bb! - \log_b\frac{1}{2} - k \approx \frac{(b-k)\log(b-k) - (b-k) + \frac{\log \biggl[ (b-k)(1+4(b-k)(1+2(b-k)))\biggr]}{6} + \frac{\log\pi}{2}}{\log b} \\
& \\
& \frac{b\log b - b + \frac{\log\biggl[ b(1+4b(1+2b)) \biggr]}{6} + \frac{log\pi}{2}}{\log b} - \log_b\frac{1}{2} - k \approx \frac{(b-k)\log(b-k) - (b-k)}{\log b} +  \\ 
& \hspace{9cm} + \frac{\frac{\log \biggl[ (b-k)(1+4(b-k)(1+2(b-k)))\biggr]}{6} + \frac{\log\pi}{2}}{\log b} \\
\end{aligned}
\]
...
\[
\begin{aligned}
		& \frac{b\log b \cancel{-b} + \frac{\log\biggl[ b(1+4b(1+2b)) \biggr]}{6} + \cancel{\frac{log\pi}{2}} - \log b \log_b\frac{1}{2} - \log b k}{\cancel{\log b}} \approx \frac{(b-k)\log(b-k) \cancel{-b} + k }{\cancel{\log b}} +  \\ 
& \hspace{10.5cm} + \frac{\frac{\log \biggl[ (b-k)(1+4(b-k)(1+2(b-k)))\biggr]}{6} + \cancel{\frac{\log\pi}{2}}}{\cancel{\log b}} \\
& \\
& \texttt{let } C = b\log b + \frac{\log\biggl[ b(1+4b(1+2b)) \biggr]}{6} - \log b \log_b\frac{1}{2} \approx (b-k)\log(b-k) + k + \log b k  \\ 
& \hspace{10.5cm} + \frac{\log \biggl[ (b-k)(1+4(b-k)(1+2(b-k)))\biggr]}{6} \\
& \\
& \texttt{let } f(k) = (b-k)\log(b-k) + k + \log b k + \frac{\log \biggl[ (b-k)(1+4(b-k)(1+2(b-k)))\biggr]}{6} - C = 0\\
