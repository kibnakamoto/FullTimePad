...
Start from 32 zeros for a key, then incremented each byte by 1 until there are 32 255s and test again.

% TODO: FINISH BENCHMARK TESTS AND TEST IF LARGE NUMBER KEYS ARE CALCULATED AT SAME SPEED AS SMALL NUMBER KEYS (E.G. 32 ZEROS).

% TODO: side channel attacks? Why not possible in fulltimepad.cpp? (algorithm is constant time)
...
higher comp: 3.125%	i: 2
higher comp: 6.25%	i: 6
higher comp: 9.375%	i: 2648
higher comp: 12.5%	i: 36595
higher comp: 15.625%	i: 6167198
higher comp: 18.75%	i: 530210645
